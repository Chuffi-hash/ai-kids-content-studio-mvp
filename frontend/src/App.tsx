...
export default function App() {
  ...
  async function goToProduction() {
    ...
    try {
      ...
      // A newly created story may not have been persisted yet. The pipeline
      // remains usable and will simply show no saved images in that case.
        ...
        <div className="app">
          <aside className="sidebar">
            ...
            <nav>
              ...
              <button className="nav-item">🧸 Characters</button>
                ...
                <section className="generator-grid">
                  <div className="panel">
                    <div className="panel-header">
                      ...
                      <p className="panel-description">Configure your story parameters</p>
                    </div>
                    <label>
                      Topic
                      <input value={topic} onChange={(e) => setTopic(e.target.value)} placeholder="e.g., Animals, Space, Friendship" />
                    </label>
                    <label>
                      Age group
                    ...
                    <label>
                      Lesson
                      <input value={lesson} onChange={(e) => setLesson(e.target.value)} placeholder="e.g., Be kind and help others" />
                    </label>
